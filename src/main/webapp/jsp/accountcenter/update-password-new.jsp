  ...
  <div class="todo"><!--圆圈灰色 todo-->
    ...
    <div class="Retrieve-cnt">
         ...
         <li class="user">
          ...
          <li class="user">
          <p class="word">确认密码</p>
          <p><input type="password" class="int-medium" placeholder=""><span class="regsiter-note"><i class="icon-caret-left"></i><img src="images/correct.png">密码必须由字母和数字/符号组成，不能低于6个字符</span></p>
          </li>
