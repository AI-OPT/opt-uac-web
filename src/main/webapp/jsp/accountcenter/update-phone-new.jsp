...
<!--右侧弹出框结束-->
  ...
  <div class="todo"><!--圆圈灰色 todo-->
    ...
    <div class="Retrieve-cnt">
         ...
         <li class="user">
          <p class="word">手机号码</p>
          <p><input type="password"class="int-medium" placeholder=""><span class="regsiter-note"><i class="icon-caret-left"></i><img src="images/correct.png">密码必须由字母和数字/符号组成，不能低于6个字符</span><!--把提示信息放在input后面即可--></p>
