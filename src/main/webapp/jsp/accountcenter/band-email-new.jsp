  ...
  <div class="header">
   ...
   <div class="nav">
     <ul>
      ...
      <li><a href="账户安全-修改手机号.html">修改邮箱</a></li>
      <li class="current"><a href="邮箱绑定-身份验证.html">邮箱设置</a></li>
     </ul>
     </div>
    </div>
   <div class="breadcrumb">
    <ul>
     <li>账号中心</li>
     <li><i class="icon-angle-right"></i>邮箱设置</li>
    </ul>
   </div>
   <div class="user">
  ...
  <div class="todo"><!--圆圈灰色 todo-->
    ...
    <div class="Retrieve-cnt">
         ...
         <li class="user">
          ...
          <p><input type="text" class="int-medium" placeholder=""><span class="regsiter-note"><i class="icon-caret-left"></i><img src="images/correct.png">密码必须由字母和数字/符号组成，不能低于6个字符</span></p>
         </li>
